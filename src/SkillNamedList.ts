import { JsonSerializable, SerializationMode } from 'dotup-ts-json-serializer';
import { NamedList } from 'dotup-ts-types';
import { ListMode } from './ListMode';
import { ListState } from './ListState';

@JsonSerializable(SerializationMode.IncludeAll)
export class SkillNamedList<T> extends NamedList<T> {
